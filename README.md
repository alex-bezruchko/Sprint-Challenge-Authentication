...
<!-- 1. What does bcrypt do to help us store passwords in a secure manner. -->
    Having an algorithm like bcrypt that hashes the information multiple times (rounds) means an 

<!-- 1. What does bcrypt do to slow down attackers? -->
    Attacker needs to have the hash, know the algorithm used, and how many rounds were used to generate the hash in the first place.
